            ...
            <section>
                <div class="container-lg mt-3">
                    <div class="row" id="pakalpojumi-icons">
                        <a href="#" class="col-sm-3 col-6 text-center"><img class="icons" src="Attēli/Tooth.jpg"/> <p class="icon-text">Zobārstniecība</p></a>
                        <a href="#" class="col-sm-3 col-6 text-center"><img class="icons" src="Attēli/Brush.jpg"/> <p class="icon-text">Kosmetoloģija</p></a>
                        <a href="#" class="col-sm-3 col-6 text-center"><img class="icons" src="Attēli/Drug.jpg"/> <p class="icon-text">Homeopātija</p></a>
                        <a href="#" class="col-sm-3 col-6 text-center"><img class="icons" src="Attēli/Massage.jpg"/> <p class="icon-text">Ārstnieciskās masāžas</p></a>
                    </div>
                </div>
            </section>
                ...
                <div class="bg-gray pb-5">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide mb-3" data-ride="carousel">
                        ...
                        <div class="d-flex justify-content-center">
                            <button class="lasit-visus-btn button rounded-pill"><a href="./par-mums">Lasīt visus rakstus</a></button>
                        </div>
