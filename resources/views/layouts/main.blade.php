    ...
    <header>
            <nav class="navbar navbar-expand-md fixed-top nav-bg pink-border-md">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">   
                            <a class="nav-link white" href="#">MŪSU PAKALPOJUMI</a>
                        </li>
                        <li class="nav-item">   
                            <a class="nav-link white" href="#">E-PIERAKSTS</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="bg-dred"> 
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="d-flex col-lg-5 col-6 align-items-end justify-content-end pr-0 mb-3 flex-lg-row flex-column">
                            ...
                            <button class="F-epieraksts rounded-pill mr-3"><a href="#">E-PIERAKSTS</a></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-3 row">
                <div class="col-5 text-right pr-3 mt-3 d-none d-lg-block">
                    ...
                    <p class="gray">SIA VSC MAILOS, Reģ.Nr. : 12345678910 <br>Adrese: Pulka ielā 3 k-9, Rīga, LV-1056 <br>&copy 2020 Veselības un skaistuma centrs MAILOS</p>  
                </div>
                <div class="col-lg-2 col-sm-12 text-center">
                    <h3 class="h5 gray">DARBA LAIKI:</h3>
                    <p class="gray text-nowrap pl-3">Pirmdienas: 09:00 - 18:00 <br>Otrdienas: 09:00 - 18:00 <br>Trešdienas: 09:00 - 17:00 <br>Ceturtdienas: 09:00 - 18:00 <br>Piektdienas: 09:00 - 17:00 <br>Sestcienas/Svētdienas: – </p>  
                </div>
                ...
                <div class="col-md-5 col-sm-6 text-sm-left col-12 text-center pl-3 pl-md-5 mt-3">
                    ...
                    <p class="gray">Tālruņa Nr.: +371 63426444 <br>E-pasts : ozoluartis@gmail.com <br>Adrese: Pulka ielā 3 k-9, Rīga, LV-1056</p>  
                </div>
            </div>
        </div>  
    </footer>
